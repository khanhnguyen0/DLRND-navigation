...
class Agent():
    ...
    def __init__(self, state_size, action_size, seed):
        ...
        # Q-Network
        self.qnetwork_local = QNetwork(state_size, action_size, seed, NETWORK_LINEAR_SIZES).to(device)
        self.qnetwork_target = QNetwork(state_size, action_size, seed, NETWORK_LINEAR_SIZES).to(device)
